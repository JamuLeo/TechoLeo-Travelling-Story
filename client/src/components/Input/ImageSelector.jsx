//anything to do with images touch here please,like size and anything to do with images
...
const ImageSelector = ({ image, setImage, handleDeleteImg }) => {
  ...
  useEffect(() => {
    // if the image property is a string (URL), set it as the previous URL
    if (typeof image === "string") {
      ...
      // if there is no image, clear the previous URL
      setPreviewUrl(null);
    }
